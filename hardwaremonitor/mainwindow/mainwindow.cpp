...
//    enetWidget->show();
    ...
    monitor = new HardwareMonitor(this);


    query = new WMIQuery(this);
...
void MainWindow::slotTimeout(){
    ...
    QString temperature = "CPU:";
//    temperature += QString::number(monitor->getCPUTemperature2(0));
//    temperature += " " + QString::number(monitor->getCPUTemperature2(1));
//    temperature += " " + QString::number(monitor->getCPUTemperature2(2));
//    temperature += " " + QString::number(monitor->getCPUTemperature2(2));
    //label->setText(monitor->getCPUTemperature());

    temperature += monitor->getCPUTemperature() + "\n";

temperature += "MotherBoard:" + QString::number(monitor->getMotherBoardTemperature()) + "\n";
temperature += "HardDisk:" + (monitor->getHardDiskTemperature()) + "\n";



qDebug()<<"HardDisk:"<<monitor->getHardDiskTemperature();
qDebug()<<"MotherBoard:"<<monitor->getMotherBoardTemperature();
